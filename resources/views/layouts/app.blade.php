...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a class="brand-link">
                <img src="{{ asset('images/LogoVisit.png') }}" alt="Visit Mojokerto Logo"
                    class="brand-image elevation-3" style="opacity: .9; object-fit: contain;">
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
                Admin Visit Mojokerto
            </div>
            <!-- Default to the left -->
            <strong>&copy; {{ date('Y') }} Admin Visit Mojokerto.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
